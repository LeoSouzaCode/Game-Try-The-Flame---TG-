...
public class Tabuleiro {
    ...
    public void aplicarEsteira(int antigaLinha, int antigaColuna, int novaLinha, int novaColuna) {
        ...
        System.out.println(">>> ESTEIRA CHAMADA <<<");
        Thread.dumpStack();
        ...
        System.out.println("DEPOIS DA ESTEIRA:");
        imprimirGridDebug();

        if (!existeMovimentoValido()) {
            System.out.println("GERANDO SAIDA EMERGENCIAL...");
            gerarSaidaEmergencial();

            System.out.println("DEPOIS DA SAIDA EMERGENCIAL:");
            imprimirGridDebug();
        }

        if (!existeChama()) {
            System.out.println("GARANTINDO CHAMA...");
            garantirUmaChama();

            System.out.println("DEPOIS DE GARANTIR CHAMA:");
            imprimirGridDebug();
        }
    }
    ...
    private void esteiraDireita(int linha) {
        ...
        TipoCarta ultima = gerarCartaEsteiraSegura();
    ...
    private void esteiraEsquerda(int linha) {
        ...
        TipoCarta primeira = gerarCartaEsteiraSegura();
